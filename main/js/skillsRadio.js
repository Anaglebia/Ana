const skills = [
    {
        title: "js",
        description: "Com domínio intermediário em JavaScript, possuo experiência na manipulação do DOM e programação assíncrona. Desenvolvo funcionalidades interativas utilizando recursos modernos do ES6+, incluindo Promises, async/await e arrow functions, criando aplicações web dinâmicas e responsivas. Tenho também experiência com React, utilizando componentes funcionais, hooks como useState e useEffect, e gerenciamento de estado para o desenvolvimento de interfaces modernas e reativas."
    },
    {
        title: "html",
